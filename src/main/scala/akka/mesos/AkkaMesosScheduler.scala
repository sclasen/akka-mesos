...
trait AkkaMesosScheduler { _: Actor =>
  ...
  /**
    * Returns this scheduler's associated driver.
    */
  ...
  /**
    * Concrete implementations should handle subclasses of
    * [AkkaMesosScheduler.SchedulerMessage].
    */
  def receive: PartialFunction[Any, Unit]

  private[this] lazy val proxy = new SchedulerProxy

  /**
    * This concrete scheduler proxies Mesos callbacks to the enclosing Actor.
    */
  class SchedulerProxy extends Scheduler {
    ...
    def frameworkMessage(
      ...
      self ! FrameworkMessage(executorId, slaveId, data)
...
object AkkaMesosScheduler {
  ...
  case class FrameworkMessage(
    executorId: ExecutorID,
    slaveId: SlaveID,
    data: Array[Byte]) extends SchedulerMessage
